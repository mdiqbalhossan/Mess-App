                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm editBtn" data-bs-toggle="modal"
                                    data-bs-target="#basicModal" data-contact_num="{{ $user->contact_number }}"
                                    data-wa_num="{{ $user->wa_number }}" data-id="{{ $user->id }}"><i
                                        class="bx bx-edit-alt me-1"></i></button>
                                <button class="btn btn-dark btn-sm smsBtn" data-bs-toggle="modal" data-bs-target="#smsModal"
                                    data-contact_num="{{ $user->contact_number }}" data-id="{{ $user->id }}"
                                    title="Send Message"><i class="bx bx-mail-send me-1"></i></button>
                                <a href="javascript:void(0);" class="btn btn-danger btn-sm"
                                    onclick="if(confirm('Are you sure want to delete?')){document.getElementById('dForm_{{ $user->id }}').submit()}"><i
                    ...
                    <div class="modal-body">
                        <div class="row g-2">
                            ...
                            <div class="col mb-0">
                                ...
                                <input type="text" name="wa_number" id="wa_number" class="form-control"
                ...
                <form action="{{ route('sendMessage') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row g-2">
                            ...
                            <div class="col mb-0">
                                <label for="contact_number" class="form-label">Contact Number</label>
                                <input type="text" name="contact_number" id="contact_number_sms" class="form-control"
                                    placeholder="012xxxxxxxx" readonly />
                            </div>
                        </div>
                        <div class="mb-3">
...
@push('js')
    ...
    <script>
        ...
        $(document).on("click", "#check_for_utility_button", function() {
            $(this).text('Updating...');
            var ids = [];
